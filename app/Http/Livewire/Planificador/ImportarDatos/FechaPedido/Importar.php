...
use App\Imports\FechaPedidoImport;
...
class Importar extends Component
{
    ...
    public function importar(){
        $this->validate();
        try {
            Excel::import(new FechaPedidoImport, $this->archivo);
    ...
    {
        return view('livewire.planificador.importar-datos.fecha-pedido.importar');
    }
}
