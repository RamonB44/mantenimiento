...
class Filtros extends Component
{
    ...
    public function filtrar(){
        $this->emitTo('supervisor.programacion-de-tractores.tabla','filtrar',$this->fecha, $this->turno, $this->fundoid, $this->loteid, $this->tractoristaid, $this->tractorid, $this->implementoid, $this->laborid);
        $this->open = false;
    }

    public function render()
    {
        return view('livewire.supervisor.programacion-de-tractores.filtros');
    }
}
