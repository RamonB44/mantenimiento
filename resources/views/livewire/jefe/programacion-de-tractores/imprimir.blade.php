    ...
    <x-jet-dialog-modal wire:model='open'>
        ...
        <x-slot name="content">
            ...
            <div class="grid items-center grid-cols-1 p-6 bg-white sm:grid-cols-2">
                <x-boton-crud accion="imprimirProgramacion" wire:loading.attr="disabled" color="red">
                    PDF
                </x-boton-crud>
                <x-boton-crud accion="exportarProgramacion" wire:loading.attr="disabled" color="green">
                    EXCEL
                </x-boton-crud>
            </div>
        </x-slot>
