<div class="grid items-center grid-cols-2 p-6 bg-white sm:grid-cols-4">
    <x-boton-crud accion="$emitTo('planificador.importar-datos.ceco.importar','abrir_modal')" color="gray">Importar</x-boton-crud>
    <x-boton-crud accion="abrir_modal(0)" color="green">Registrar</x-boton-crud>
    <x-boton-crud accion="abrir_modal({{$ceco_id}})" color="amber" :activo="$boton_activo">Editar</x-boton-crud>
